...
public class PrivateAnswer implements org.apache.thrift.TBase<PrivateAnswer, PrivateAnswer._Fields>, java.io.Serializable, Cloneable, Comparable<PrivateAnswer> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new PrivateAnswerStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new PrivateAnswerTupleSchemeFactory();

  public long analystId; // required
  public long queryId; // required
  public java.nio.ByteBuffer privateAnswerBits; // required
  ...
  public PrivateAnswer(
    long analystId,
    long queryId,
    java.nio.ByteBuffer privateAnswerBits,
    int bitlen,
    long joinId,
    long versionId)
  {
  ...
  public java.nio.ByteBuffer bufferForPrivateAnswerBits() {
  ...
  public PrivateAnswer setPrivateAnswerBits(byte[] privateAnswerBits) {
    this.privateAnswerBits = privateAnswerBits == null ? (java.nio.ByteBuffer)null : java.nio.ByteBuffer.wrap(privateAnswerBits.clone());
    return this;
  }

  public PrivateAnswer setPrivateAnswerBits(java.nio.ByteBuffer privateAnswerBits) {
    this.privateAnswerBits = org.apache.thrift.TBaseHelper.copyBinary(privateAnswerBits);
    return this;
  }
  ...
  public void unsetBitlen() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __BITLEN_ISSET_ID);
  }

  /** Returns true if field bitlen is set (has been assigned a value) and false otherwise */
  public boolean isSetBitlen() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __BITLEN_ISSET_ID);
  }

  public void setBitlenIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __BITLEN_ISSET_ID, value);
  }
  ...
  public void unsetJoinId() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __JOINID_ISSET_ID);
  }

  /** Returns true if field joinId is set (has been assigned a value) and false otherwise */
  public boolean isSetJoinId() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __JOINID_ISSET_ID);
  }

  public void setJoinIdIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __JOINID_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case PRIVATE_ANSWER_BITS:
      if (value == null) {
        ...
        if (value instanceof byte[]) {
          setPrivateAnswerBits((byte[])value);
        } else {
          setPrivateAnswerBits((java.nio.ByteBuffer)value);
        }
      }
      break;
    ...
    case BITLEN:
      if (value == null) {
        ...
        setBitlen((java.lang.Integer)value);
      }
      break;
    ...
    case JOIN_ID:
      if (value == null) {
        ...
        setJoinId((java.lang.Long)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetPrivateAnswerBits()) ? 131071 : 524287);
    if (isSetPrivateAnswerBits())
      hashCode = hashCode * 8191 + privateAnswerBits.hashCode();

    hashCode = hashCode * 8191 + bitlen;

    hashCode = hashCode * 8191 + org.apache.thrift.TBaseHelper.hashCode(joinId);
  ...
  public int compareTo(PrivateAnswer other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetPrivateAnswerBits()).compareTo(other.isSetPrivateAnswerBits());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPrivateAnswerBits()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetBitlen()).compareTo(other.isSetBitlen());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBitlen()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetJoinId()).compareTo(other.isSetJoinId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetJoinId()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("PrivateAnswer(");
    boolean first = true;
  ...
  private static class PrivateAnswerStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public PrivateAnswerStandardScheme getScheme() {
      return new PrivateAnswerStandardScheme();
    }
  }

  private static class PrivateAnswerStandardScheme extends org.apache.thrift.scheme.StandardScheme<PrivateAnswer> {
  ...
  private static class PrivateAnswerTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public PrivateAnswerTupleScheme getScheme() {
      return new PrivateAnswerTupleScheme();
    }
  }

  private static class PrivateAnswerTupleScheme extends org.apache.thrift.scheme.TupleScheme<PrivateAnswer> {
