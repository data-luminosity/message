...
type PrivateAnswer struct {
  ...
  PrivateAnswerBits []byte `thrift:"privateAnswerBits,3" db:"privateAnswerBits" json:"privateAnswerBits"`
  Bitlen int32 `thrift:"bitlen,4" db:"bitlen" json:"bitlen"`
  JoinId int64 `thrift:"joinId,5" db:"joinId" json:"joinId"`
  VersionId int64 `thrift:"versionId,6" db:"versionId" json:"versionId"`
}
